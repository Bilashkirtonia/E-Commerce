                        ...
                        <tbody>
                            @foreach ($orders as $key => $order)
                                <tr>
                                    ...
                                    <th>
                                        @if ($order->status == '0')
                                            <a href="{{ route('customer_approve_details',$order->id) }}" class="btn btn-danger">Unapprove</a>
                                        @elseif ($order->status == '1')
                                            <a href="{{ route('customer_order_details',$order->id) }}" class="text-success">Approve</a>
                                        @endif
                                    </th>
                                    <th>
